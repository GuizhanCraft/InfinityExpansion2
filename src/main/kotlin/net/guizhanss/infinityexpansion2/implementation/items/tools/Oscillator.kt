...
class Oscillator(
...
) : UnplaceableBlock(itemGroup, itemStack, recipeType, recipe), DistinctiveItem {
    ...
    companion object {
         ...
         */
        fun isOscillator(item: ItemStack) =
            item.hasItemMeta() && PersistentDataAPI.hasString(item.itemMeta, Keys.OSCILLATOR_TARGET)
